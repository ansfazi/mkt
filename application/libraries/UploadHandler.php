...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        if ($options) {
            $res = $this->options = $options + $this->options;
        }
        if ($error_messages) {
            $res = $this->error_messages = $error_messages + $this->error_messages;
        }
        if ($initialize) {
            $res = $this->initialize();
        }
    ...
    protected function trim_file_name($file_path, $name, $size, $type, $error,
        ...
        $name = trim(basename(stripslashes( preg_replace('/[^A-Za-z0-9\.-]+/', '-',$name))), ".\x00..\x20");
